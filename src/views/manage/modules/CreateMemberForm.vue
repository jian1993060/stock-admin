    ...
    <a-spin :spinning="loading">
      ...
      >
        ...
        <a-form-model-item label="运营中心" prop="yyzx">
          <a-radio-group v-model="ruleForm.yyzx" default-value="1">
            <a-radio value="1"> 是 </a-radio>
            <a-radio value="2"> 否 </a-radio>
          </a-radio-group>
        </a-form-model-item>
        <a-form-model-item label="分公司" prop="fgs">
          <a-radio-group v-model="ruleForm.fgs" default-value="1">
            <a-radio value="1"> 是 </a-radio>
            <a-radio value="2"> 否 </a-radio>
          </a-radio-group>
        </a-form-model-item>
...
export default {
  ...
  methods: {
    open (record) {
      if (record.userLevel) record.userLevel = record.userLevel + ''
